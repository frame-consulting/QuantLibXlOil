...
def qlDepositRateHelper2(
    rate: qQuoteHandle, index: ql.IborIndex, trigger=None
) -> ql.DepositRateHelper:
    return ql.DepositRateHelper(rate, index)
...
def qlDepositRateHelper3(
    rate: qQuoteHandle, fixing_date: qDate, index: ql.IborIndex, trigger=None
) -> ql.DepositRateHelper:
    return ql.DepositRateHelper(rate, fixing_date, index)
...
def qlFRARateHelper2(
    ...
    return ql.FraRateHelper(
        rate, month_to_start, index, pillar, custom_pillar_date, use_indexed_coupon
    )
...
def qlFRARateHelper4(
    ...
    return ql.FraRateHelper(
        rate, period_to_start, index, pillar, custom_pillar_date, use_indexed_coupon
    )
...
def qlFuturesRateHelper2(
    ...
    return ql.FuturesRateHelper(
        price, ibor_start_date, ibor_end_date, day_counter, convexity_adjustment, type
    )
...
def qlFuturesRateHelper3(
    ...
    return ql.FuturesRateHelper(
        price, ibor_start_date, index, convexity_adjustment, type
    )
...
def qlFuturesRateConvexityAdjustment(
    futures_rate_helper: ql.FuturesRateHelper, trigger=None
) -> float:
...
def qlSwapRateHelperSwap(
    swap_rate_helper: ql.SwapRateHelper, trigger=None
) -> ql.VanillaSwap:
...
def qlOISRateHelperSwap(
    ois_rate_helper: ql.OISRateHelper, trigger=None
) -> ql.VanillaSwap:
...
def qlFxSwapRateHelperSpot(
    fx_swap_rate_helper: ql.FxSwapRateHelper, trigger=None
) -> float:
...
def qlFxSwapRateHelperFixingDays(
    fx_swap_rate_helper: ql.FxSwapRateHelper, trigger=None
) -> int:
...
def qlFxSwapRateHelperCalendar(
    fx_swap_rate_helper: ql.FxSwapRateHelper, trigger=None
) -> ql.Calendar:
...
def qlFxSwapRateHelperBusinessDayConvention(
    fx_swap_rate_helper: ql.FxSwapRateHelper, trigger=None
...
def qlFxSwapRateHelperEndOfMonth(
    fx_swap_rate_helper: ql.FxSwapRateHelper, trigger=None
) -> bool:
...
def qlFxSwapRateHelperIsFxBaseCurrencyCollateralCurrency(
    fx_swap_rate_helper: ql.FxSwapRateHelper, trigger=None
) -> bool:
...
def qlFxSwapRateHelperTradingCalendar(
    fx_swap_rate_helper: ql.FxSwapRateHelper, trigger=None
) -> ql.Calendar:
...
def qlFxSwapRateHelperAdjustmentCalendar(
    fx_swap_rate_helper: ql.FxSwapRateHelper, trigger=None
) -> ql.Calendar:
...
def qlOvernightIndexFutureRateHelperConvexityAdjustment(
    overnight_index_future_rate_helper: ql.OvernightIndexFutureRateHelper, trigger=None
) -> float:
...
def qlIborIborBasisSwapRateHelperSwap(
    ibor_ibor_basis_swap_rate_helper: ql.IborIborBasisSwapRateHelper, trigger=None
) -> ql.VanillaSwap:
...
def qlOvernightIborBasisSwapRateHelperSwap(
    overnight_ibor_basis_swap_rate_helper: ql.OvernightIborBasisSwapRateHelper,
    trigger=None,
) -> ql.VanillaSwap:
