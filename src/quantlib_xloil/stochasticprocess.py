...
def qlStochasticProcessInitialValues(
    process: ql.StochasticProcess, trigger=None
) -> list[float]:
    return to_float_list(process.initialValues())
...
def qlStochasticProcessDrift(
    process: ql.StochasticProcess, t: float, x: xlo.Array(dims=1), trigger=None
) -> list[float]:
    return to_float_list(process.drift(t, ql.Array(to_float_list(x))))
...
def qlStochasticProcessDiffusion(
    process: ql.StochasticProcess, t: float, x: xlo.Array(dims=1), trigger=None
) -> list[list[float]]:
    return to_float_matrix(process.diffusion(t, ql.Array(to_float_list(x))))
...
def qlStochasticProcessExpectation(
    process: ql.StochasticProcess,
    t0: float,
    x0: xlo.Array(dims=1),
    dt: float,
    trigger=None,
) -> list[float]:
    return to_float_list(process.expectation(t0, ql.Array(to_float_list(x0)), dt))
...
def qlStochasticProcessStdDeviation(
    process: ql.StochasticProcess,
    t0: float,
    x0: xlo.Array(dims=1),
    dt: float,
    ...
    return to_float_matrix(process.stdDeviation(t0, ql.Array(to_float_list(x0)), dt))
...
def qlStochasticProcessCovariance(
    process: ql.StochasticProcess,
    t0: float,
    x0: xlo.Array(dims=1),
    dt: float,
    ...
    return to_float_matrix(process.covariance(t0, ql.Array(to_float_list(x0)), dt))
...
def qlStochasticProcessEvolve(
    ...
    return to_float_list(
        process.evolve(t0, ql.Array(to_float_list(x0)), dt, ql.Array(to_float_list(dw)))
    )
...
def qlStochasticProcess1DDrift(
    process: ql.StochasticProcess1D, t: float, x: float, trigger=None
) -> float:
...
def qlStochasticProcess1DDiffusion(
    process: ql.StochasticProcess1D, t: float, x: float, trigger=None
) -> float:
...
def qlStochasticProcess1DExpectation(
    process: ql.StochasticProcess1D, t0: float, x0: float, dt: float, trigger=None
) -> float:
...
def qlStochasticProcess1DStdDeviation(
    process: ql.StochasticProcess1D, t0: float, x0: float, dt: float, trigger=None
) -> float:
...
def qlStochasticProcess1DVariance(
    process: ql.StochasticProcess1D, t0: float, x0: float, dt: float, trigger=None
) -> float:
...
def qlStochasticProcess1DEvolve(
    process: ql.StochasticProcess1D,
    t0: float,
    x0: float,
    dt: float,
    dw: float,
...
def qlStochasticProcess1DApply(
    process: ql.StochasticProcess1D, x0: float, dx: float, trigger=None
) -> float:
...
def qlGeneralizedBlackScholesProcess(
    ...
    return ql.GeneralizedBlackScholesProcess(
        s0, dividend_ts, risk_free_ts, vol_ts, local_vol_ts
    )
...
def qlGeneralizedBlackScholesProcessStateVariable(
...
def qlGeneralizedBlackScholesProcessDividendYield(
    process: ql.GeneralizedBlackScholesProcess, trigger=None
...
def qlGeneralizedBlackScholesProcessRiskFreeRate(
    process: ql.GeneralizedBlackScholesProcess, trigger=None
) -> ql.YieldTermStructureHandle:
...
def qlGeneralizedBlackScholesProcessBlackVolatility(
    process: ql.GeneralizedBlackScholesProcess, trigger=None
...
def qlGeneralizedBlackScholesProcessLocalVolatility(
    process: ql.GeneralizedBlackScholesProcess, trigger=None
...
def qlGarmanKohlagenProcess(
    ...
    return ql.GarmanKohlagenProcess(
        s0, foreign_risk_free_ts, domestic_risk_free_ts, vol_ts
    )
...
def qlHestonProcess(
    ...
    return ql.HestonProcess(
        risk_free_ts, dividend_ts, s0, v0, kappa, theta, sigma, rho, discretization
    )
...
def qlHestonProcessDividendYield(
    process: ql.HestonProcess, trigger=None
) -> ql.YieldTermStructureHandle:
    return process.dividendYield()
...
def qlHestonProcessRiskFreeRate(
    process: ql.HestonProcess, trigger=None
) -> ql.YieldTermStructureHandle:
    return process.riskFreeRate()
...
def qlHullWhiteForwardProcessAlpha(
    process: ql.HullWhiteForwardProcess, t: float, trigger=None
) -> float:
...
def qlHullWhiteForwardProcessMT(
    process: ql.HullWhiteForwardProcess,
    s: float,
    t: float,
    t_measure: float,
    trigger=None,
...
def qlHullWhiteForwardProcessB(
    process: ql.HullWhiteForwardProcess, s: float, t: float, trigger=None
) -> float:
...
def qlHullWhiteForwardProcessSetForwardMeasureTime(
    process: ql.HullWhiteForwardProcess, t: float, trigger=None
) -> bool:
...
def qlG2ForwardProcessSetForwardMeasureTime(
...
def qlGsrProcess(
    ...
    times_ = ql.Array(to_float_list(times))
    vols_ = ql.Array(to_float_list(vols))
    reversions_ = ql.Array(to_float_list(reversions))
...
def qlGsrProcessG(
    process: ql.GsrProcess, t: float, T: float, x: float, trigger=None
) -> float:
...
def qlGsrProcessSetForwardMeasureTime(
    process: ql.GsrProcess, t: float, trigger=None
) -> bool:
...
def qlOrnsteinUhlenbeckProcessSpeed(
    process: ql.OrnsteinUhlenbeckProcess, trigger=None
) -> float:
...
def qlOrnsteinUhlenbeckProcessVolatility(
    process: ql.OrnsteinUhlenbeckProcess, trigger=None
) -> float:
...
def qlOrnsteinUhlenbeckProcessLevel(
    process: ql.OrnsteinUhlenbeckProcess, trigger=None
) -> float:
...
def qlGJRGARCHProcessDividendYield(
    process: ql.GJRGARCHProcess, trigger=None
) -> ql.YieldTermStructureHandle:
    return process.dividendYield()
...
def qlGJRGARCHProcessRiskFreeRate(
    process: ql.GJRGARCHProcess, trigger=None
) -> ql.YieldTermStructureHandle:
    return process.riskFreeRate()
