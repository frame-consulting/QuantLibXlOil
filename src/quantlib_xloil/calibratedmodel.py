...
def _to_ql_calibration_helpers(calibration_helpers) -> tuple[ql.calibration_helpers]:
    ...
    raise ValueError(f"Cannot convert {calibration_helpers} to list of QuantLib CashFlows.")
...
@xlo.func(
    ...
    args={
        'model': 'The QuantLib CalibratedModel to get parameters from.'
    },
    group=EXCEL_GROUP_NAME,
)
...
@xlo.func(
    ...
    args={
        'model': 'The QuantLib CalibratedModel to get the constraint for.'
    },
    group=EXCEL_GROUP_NAME,
)
...
@xlo.func(
    ...
    args={
        'model': 'The QuantLib CalibratedModel to get the end criteria for.'
    },
    group=EXCEL_GROUP_NAME,
)
...
@xlo.func(
    ...
    args={
        'model': 'The QuantLib CalibratedModel to get the problem values for.'
    },
    group=EXCEL_GROUP_NAME,
)
...
@xlo.func(
    ...
    args={
        'model': 'The QuantLib CalibratedModel to get the function evaluations for.'
    },
    group=EXCEL_GROUP_NAME,
)
...
@xlo.func(
    ...
    args={
        'model': 'The QuantLib CalibratedModel to create a handle for.'
    },
    group=EXCEL_GROUP_NAME,
)
